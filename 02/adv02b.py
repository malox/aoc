...
#        "3 8 6 5" ]
    ...
    x=[ "6046 6349 208 276 4643 1085 1539 4986 7006 5374 252 4751 226 6757 7495 2923",
    ...
    sum = 0;
    for a in range(0, len(p2)) :
        pa = p2[a]
        print "A[" + str(a) + "] " + str(p2[a])
        for b in range(0, len(pa)) :
            pb = pa[b]
            #print "B[" + str(b) + "] " + str(pb])
            for c in range(b+1, len(pa)):
                pc = pa[c]
                if (pb%pc==0):
                    sum += pb/pc
                elif (pc%pb==0):
